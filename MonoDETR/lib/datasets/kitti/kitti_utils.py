...
def get_affine_transform(center,
    ...
    src[0, :] = center + scale_tmp * shift #As shift is zero -> this center goes to center of image
    src[1, :] = center + src_dir + scale_tmp * shift #As shift is zero -> this center + direction goes to center + final direction. Basically scaling the image
