...
def main():
    ...
    # Inject canonical_focal_length from dataset config to model config
    if 'canonical_focal_length' in cfg['dataset']:
        cfg['model']['canonical_focal_length'] = cfg['dataset']['canonical_focal_length']
    ...
    if cfg['continue_train']:
        checkpoint_path = os.path.join(output_path, "checkpoint_best.pth")
